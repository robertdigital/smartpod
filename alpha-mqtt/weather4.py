...
while True:
    ...
    #location = parsed_json['observations'][0]['stationID']
    humidity = 20 + random.randrange(10) 
    temp_f = 60 + random.randrange(10) 
    pressure = 28 + random.randrange(3) 
    windSpeed = 3 + random.randrange(10) 
    ...
    client.publish("seapod/weather", x)
    client.disconnect()
